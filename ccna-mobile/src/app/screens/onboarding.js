...
const STEPS = [
  {
    ...
    hint: 'Поменять можно в любой момент — ничего не пересчитывается задним числом.',
    options: [
  ...
  },
  {
    ...
    hint: 'Точную дату можно указать в «Профиле» — тогда на главной появится обратный отсчёт и норма пересчитается сама.',
    options: [
