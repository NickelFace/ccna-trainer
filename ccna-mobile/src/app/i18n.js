...
const STRINGS = {
  ...
  'profile.theme.system': { ru: 'Как в системе', en: 'System' },
  'profile.theme.light': { ru: 'Светлая', en: 'Light' },
  'profile.theme.dark': { ru: 'Тёмная', en: 'Dark' },
  'profile.theme.hint': { ru: '«Как в системе» следует настройке телефона — свет днём, тёмная вечером, если включён Android auto-dark.', en: '"System" follows the phone setting — light in the day, dark in the evening if Android auto-dark is on.' },
