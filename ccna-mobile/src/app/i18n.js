...
const STRINGS = {
  ...
  'profile.theme.light.title': { ru: 'Светлая', en: 'Light' },
  'profile.theme.light.note': { ru: 'для чтения при свете и днём на улице', en: 'for daylight and bright rooms' },
  'profile.theme.dark.title': { ru: 'Тёмная', en: 'Dark' },
  'profile.theme.dark.note': { ru: 'как было до этой версии', en: 'the way it was before this version' },
  'profile.theme.system.title': { ru: 'Как в системе', en: 'Follow the system' },
  'profile.theme.system.note': { ru: 'следовать настройке Android', en: "follow Android's own setting" },
  'profile.theme.hint': { ru: 'Схемы вопросов и полноэкранный просмотр остаются на чёрном фоне в любой теме.', en: 'Exhibits and the full-screen viewer stay on black in either theme.' },
  ...
  'question.cliLines': { ru: '{n} {lines}', en: '{n} {lines}' },
  'question.cliLinesScroll': { ru: '{n} {lines}, прокрутка внутри блока', en: '{n} {lines}, scrolls inside the block' },
  'question.cliOpen': { ru: 'Открыть целиком', en: 'Open full screen' },
  'question.cliTitle': { ru: 'вывод команды', en: 'command output' },
