...
//
// The intervals and the transition of one graded answer live in the shared module the
// import below points at: the web trainer grades answers into the same map, so the two
// clients must promote and schedule a question identically. Everything below — the queue,
// the histogram, the ghost sweep — is this app's alone.
//
// State per question: { box: 1..5, dueAt, lastResult, seenCount }.
import { INTERVAL_DAYS, MAX_BOX, DAY_MS, intervalMs, nextState } from '../../../ccna-exam-simulator/assets/js/shared/srs.js';
