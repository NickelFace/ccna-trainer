...
} from '../../../ccna-exam-simulator/assets/js/shared/progress.js?v=16';
import { dayKey, daySum, normalizeActivity } from '../../../ccna-exam-simulator/assets/js/shared/activity.js?v=16';
