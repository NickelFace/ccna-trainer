...
} from '../../../ccna-exam-simulator/assets/js/shared/progress.js?v=22';
import { dayKey, daySum, normalizeActivity } from '../../../ccna-exam-simulator/assets/js/shared/activity.js?v=22';
